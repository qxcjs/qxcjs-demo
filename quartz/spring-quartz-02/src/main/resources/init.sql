...
(
    ...
    bean_name          varchar(255)        default null comment '服务类名',
    method_name        varchar(255)        default null comment '服务方法名',
    invoke_param       varchar(255)        default null comment '方法参数',
    invoke_param_class varchar(255)        default null comment '方法参数类名',
    description        varchar(255)        default null comment '任务描述',
    status             tinyint(2) not null default 0 comment '状态 0 启动 1 停止',
    del_flag           tinyint(2) not null default 0 comment '软删除标记 0 正常 1 删除',
    create_time        timestamp  not null default current_timestamp comment '创建时间',
    update_time        timestamp  not null default current_timestamp on update current_timestamp comment '更新时间',
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE KEY uniq_job_name_job_group (`job_name`, `job_group`)
) engine = innodb
  auto_increment = 0
...
(
    ...
    ENGINE = InnoDB comment ='触发器和作业映射关系';
...
(
    ...
    ENGINE = InnoDB comment '存储与已触发的 Trigger 相关的状态信息';
